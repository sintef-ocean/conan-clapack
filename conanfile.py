...
class ClapackConan(ConanFile):
    ...
    def source(self):
        ...
        tools.patch(patch_file="patch/MainCMakeLists.patch", base_path=self.source_subfolder)
        ...
        shutil.move(self.source_subfolder + "/COPYING", self.source_subfolder + "/LICENSE")
